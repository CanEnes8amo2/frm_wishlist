    ...
    <form action="{{ route('posts.update',$post->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Price:</strong>
                    <input type="number" class="form-control" name="price" placeholder="Price" value={{ $post->price }}></input>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" name="link" placeholder="Link" value="{{ $post->link }}"></input>
                </div>
            </div>
